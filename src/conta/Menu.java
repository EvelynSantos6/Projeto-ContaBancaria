...
public class Menu {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("      4 - Atualiza Dados da Conta             ");
	...
	public static void sobre() {
		System.out.println("\n*********************************************************");
		System.out.println("Projeto Desenvolvido por: Evelyn Pereira dos Santos");
		System.out.println("Generation Brasil - generation@generation.org");
		System.out.println("github.com/EvelynSantos6");
		System.out.println("*********************************************************");
